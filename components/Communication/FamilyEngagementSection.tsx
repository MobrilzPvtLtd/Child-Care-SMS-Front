    ...
    <div className="bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          {/* Images */}
          <div className="w-full md:w-1/2 md:py-16 flex justify-center items-center relative">
            <div className="relative">
              ...
              {/* Second booklet image */}
              <div className="relative top-44 left-24 md:left-60 z-20">
                <img 
                  src="banner-img.jpg" 
                  alt="Parent Communication Toolkit content page" 
                  className="w-48 md:w-76 shadow-lg rounded-md"
                />
              </div>
            </div>
...
export default FamilyEngagementSection;