...
const PartnershipBanner = () => {
  return (
    <div className="relative bg-pink-50 py-12 px-4 overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="flex justify-center items-center space-x-2 mb-8">
        ...
        <img 
          ...
          alt="experience curriculum logo" 
          className="h-8"
        />
      </div>
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-purple-800 rounded-lg p-8 text-white flex flex-col md:flex-row gap-6">
          {/* Left side images */}
          <div className="w-full md:w-2/5 relative">
            <div className="relative z-10">
              <img 
                src="/api/placeholder/300/280" 
                alt="Curriculum materials sample" 
            ...
            <div className="absolute bottom-4 -left-2 z-20">
              <img 
                ...
                alt="Preschool child" 
                className="rounded-md border-4 border-purple-800 shadow-lg"
              />
            </div>
          </div>
          ...
          <div className="w-full md:w-3/5">
            ...
            <p className="text-white/90 mb-6">
              Experience Curriculum is now in brightwheel! Support child development with expert-designed 
              lesson plans and high-quality, hands-on learning materials for baby, toddler, and preschool programs.
            </p>
