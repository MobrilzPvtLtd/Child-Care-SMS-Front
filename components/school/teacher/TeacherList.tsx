      ...
      {showWelcome && (
        <div className="bg-[#DDEEEE] border-l-4  border-[#29B9BB] p-4 mb-6 rounded-md flex justify-between items-start">
          <div className="flex gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800 mb-1">Welcome to your Teacher list!</h2>
              <p className="text-gray-600">
                This is where you will add and manage all Teacher in your school. Explore flowysis's functionality with the demo students.
              </p>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="w-1/3 relative">
          <div className="border border-indigo-200 bg-indigo-50 rounded-md p-2 flex items-center">
            <span className="mr-1 text-gray-700">Teacher status</span>
