          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-md mx-auto lg:mx-0">
              ...
              <h1 className="text-white text-4xl md:text-5xl font-bold">
                Streamline your childcare center enrollment
              </h1>
              <p className="text-white text-lg my-8 ">
                Say goodbye to endless back-and-forth paperwork and hello to an
                easy, digital enrollment process for both administrators and
                families.
              </p>
