          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-xl mx-auto lg:mx-0">
              ...
              <h1 className="text-white text-4xl md:text-5xl leading-13 tracking-wide  font-bold mb-8">
                The easiest all-in-one solution for childcare management
              </h1>
              <p className="text-white text-xl mb-6">
                Simplify your billing processes, increase enrollment, and build
                deeper connections with families and staff. Do it all with
                Flowysis.
              </p>
