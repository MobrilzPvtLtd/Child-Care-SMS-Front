  ...
  return (
    <div className="max-w-7xl mx-auto pt-20 pb-28">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-16">
        Why millions of educators and families love Flowysis daily reports
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0">
        ...
        <FeatureCard
          ...
          description="Enable teachers to easily record photos, videos, activities, and learning milestones all from the Flowysis app."
        />
        ...
        <FeatureCard
          ...
          description="Digitize your daily reports and send automated summaries to families every day."
        />
        ...
        <FeatureCard
          ...
          description="95% of admins and staff report that Flowysis improves communication with families."
        />
        <FeatureCard
          icon={
            <div className="bg-blue-400 rounded-full p-4 w-16 h-16 flex items-center justify-center">
