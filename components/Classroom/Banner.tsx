  ...
  return (
    <section className="max-w-7xl mx-auto pt-4 pb-28">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-16">
        Why Flowysis is the top choice for classroom organization
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0">
        ...
        <FeatureCard
          ...
          description="Assign staff and children to specific rooms, check ratios, and manage absences."
        />
        ...
        <FeatureCard
          ...
          description="Eliminate manual check-in processes and record observations with a few taps."
        />
        ...
        <FeatureCard
          ...
          description="Integrate your curriculum with user-friendly lesson planning tools."
        />
        ...
        <FeatureCard
          ...
          description="Create strong partnerships with families and share updates in real-time."
        />
      </div>
    </section>
  );
