  ...
  return (
    <section className="max-w-7xl mx-auto pt-4 pb-28">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-16">
        Why brightwheel is the #1 childcare staff scheduling software
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0">
        ...
        <FeatureCard
          ...
          description="Sync time tracking and payroll with brightwheel’s integration with Gusto. Manage staff schedules with the same software you use for billing and communication."
        />
