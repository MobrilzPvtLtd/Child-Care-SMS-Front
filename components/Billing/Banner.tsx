...
export default function Banner() {
  return (
    <div className="min-h-screen bg-[#03a39c]">
      <Header2 />
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-xl mx-auto lg:mx-0">
              ...
              <p className="text-white text-xl mb-6">
                Request your free, personalized demo, and we’ll connect you with
                our team so you can see how easy it is to get started on
                billing.
              </p>
